...
<head>
  <meta charset="UTF-8" />
  <title>Edit Unit - Rental PS Dashboard</title>
...
<body>
  ...
  <main class="content p-4">
    <div class="container-fluid" style="max-width: 900px;">
      <div class="mb-4">
        <h1 class="fs-3 fw-bold mb-1">Edit Unit / Produk</h1>
        <p class="text-muted">Ubah data unit inventaris kamu.</p>
      </div>
          ...
          <form action="{{ route('products.update', $product->id) }}" method="POST">
            ...
            <div class="row g-3">
              ...
              <div class="col-md-6">
                ...
                <input type="number" name="stock" class="form-control" value="{{ $product->stock ?? 1 }}" required>
              </div>
              <div class="col-md-6">
                <label class="form-label fw-semibold">Kategori</label>
                <select name="category" class="form-select">
                  <option value="Console PS" {{ ($product->category ?? '') == 'Console PS' ? 'selected' : '' }}>Console PS</option>
              ...
              <div class="col-12 mt-4">
                <button type="submit" class="btn btn-warning px-4 fw-semibold text-white">Update Unit</button>
